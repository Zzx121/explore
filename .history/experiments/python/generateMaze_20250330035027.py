...
start_end_list = [(2, randint(2, maze_height - 1)), 
                  (randint(2, maze_width - 1), 2), 
                  (maze_width - 1, randint(2, maze_height - 1)),
                  (randint(2, maze_width - 1), maze_height - 1)]
...
end_axis = start_end_list.pop(randint(0, 3))
print(f"start axis: {start_axis}")
